           ...
           <Container>
            ...
            <Row>
              ...
              <img
                ...
                className="img  img-no-padding img-responsive " style={{width:'20rem'}}
              ...
              outline href="https://fabianesantos.github.io/SCL014-social-network/src/index.html#/inicio-sesion">
                      Prototipo
                    </Button>','
                    <Button  className="btn-round mr-1"
                   color="neutral"
              ...
              outline  margin= '13px' href="https://github.com/Ladypino/SCL014-social-network">
                     Repositorio
                    </Button>
              ...
              <Col md="4">
                ...
                <img className="img  img-no-padding img-responsive "style={{width:'20rem'}}
              ...
              outline href="https://burger-queen-5875a.web.app/">
                    Prototipo
                    </Button>','
                    <Button  className="btn-round mr-1"
                   color="neutral"
              ...
              outline href="https://github.com/Ladypino/burger-queen">
                  Repositorio
                    </Button>
                  </div>
                </div>
              ...
              <Col md="4">
               ...
               className="img-no-padding img-responsive " style={{width:'20rem'}}
             ...
             />
              ...
              outline href="https://comida-para-todos-28f10.web.app/">
                      Prototipo
                    </Button> ','
              ...
              outline href="https://github.com/Ladypino/comida-para-todos">
                      Repositorio
                    </Button>
                  </div>
                </div>
